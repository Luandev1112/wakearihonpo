...
<html lang="ja"><head>
<meta charset="utf-8">
<title><?php echo $name; ?>｜群馬県伊勢崎市の熟女パブ「わけあり本舗」</title>
<meta name="description" content="群馬県伊勢崎市の熟女パブ・熟女キャバクラ「わけあり本舗」<?php echo $name; ?>ページです。伊勢崎市の熟女パブ・熟女キャバクラで楽しむ・働くなら「わけあり本舗」">
<meta name="keywords" content="<?php echo $name; ?>,熟女パブ,キャバクラ,伊勢崎,群馬,わけあり本舗">
...
<link rel="canonical" href="https://www.wakearihonpo.com/prof.php?name2=<?php echo $name2; ?>">
...
?>
	...
	echo "<div class=\"element_prof_sns\"><a href=\"".$profinfo9."\" target=\"_blank\" title=\"Instagram\"><img src=\"\" data-src=\"img/instagram_2.svg\" class=\"lozad\" alt=\"Instagram\" /></a></div>";			
			}
		if($option3 == ''){
	echo "";
}else{
	echo "<div class=\"element_prof_sns\"><a href=\"".$option3."\" target=\"_blank\" title=\"You Tube\"><img src=\"img/youtube_2.svg\" alt=\"You Tube\" /></a></div>";			
			}
										if($profinfo10 == ''){
	echo "";
}else{
	echo "<div class=\"element_prof_sns\"><a href=\"".$profinfo10."\" target=\"_blank\" title=\"Twitter\"><img src=\"img/twitter_2.svg\" alt=\"Twitter\" /></a></div>";			
			}
										if($option5 == ''){
	echo "";
}else{
	echo "<div class=\"element_prof_sns\"><a href=\"".$option5."\" target=\"_blank\" title=\"Tik Tok\"><img src=\"img/tiktok_2.svg\" alt=\"Tik Tok\" /></a></div>";			
			}
										?>
									</div>
								</div>
...
echo "<div class=\"li\" style=\"margin-bottom: 0; vertical-align: bottom;\">
	...
	echo	"</div></div>
				...
				if ($cnt != '0') {
	echo '</div>
						<div class="top_instagram_powered"><a href="https://www.nightgram.com/gunma/takasaki/" target="_blank" title="高崎市キャバクラ情報サイト「ナイトグラム」">powered by NIGHTGRAM</a></div>
					</div>';
}
?>
